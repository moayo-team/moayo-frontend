...
export const Badge = ({ dday, deadline }: BadgeProps): JSX.Element => {
  ...
  return (
    <div className={`inline-flex px-2 py-1 self-stretch flex-[0_0_auto] ${
      ...
      <div className="inline-flex items-center gap-[9px] relative flex-[0_0_auto] mt-[-1.50px] mb-[-1.50px]">
        ...
        } text-[11px] leading-[var(--body-b2-200-line-height)] whitespace-nowrap relative tracking-[var(--body-b2-200-letter-spacing)] [font-style:var(--body-b2-200-font-style)]`}>
          {dDay}
        </time>
      </div>
    </div>
