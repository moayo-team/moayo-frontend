...
export const SuccessModal = ({
  ...
  return (
    ...
    >
      <div className="inline-flex items-center justify-center gap-2.5 px-8 px-[50px] py-10 relative bg-gray-scalegray-scale-50 rounded-[30px] shadow-lg">
        <div className="flex flex-col w-[480px] items-start gap-6 relative">
          ...
          <div className="flex items-center justify-end gap-4 relative self-stretch w-full mt-2">
            <button
              className="all-[unset] box-border flex w-[120px] items-center justify-center gap-2.5 py-3 relative flex-[0_0_auto] bg-primaryprimary-300 rounded-[10px] cursor-pointer hover:bg-primaryprimary-400 transition-colors"
