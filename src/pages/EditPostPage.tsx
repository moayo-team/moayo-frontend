        ...
        <div className="flex justify-center">
          ...
          <main className="flex-1">
            <header className="flex items-center justify-between gap-4 mb-8">
              <h1 className="relative w-fit font-heading-h1-200 font-[number:var(--heading-h1-200-font-weight)] text-black text-2xl md:text-[26px] tracking-[var(--heading-h1-200-letter-spacing)] leading-[var(--heading-h1-200-line-height)] [font-style:var(--heading-h1-200-font-style)]">
                게시글 수정하기
              </h1>
            </header>
            ...
            <form className="flex flex-col gap-6">
              ...
              <section className="flex flex-col w-full items-start gap-2.5 p-5 bg-gray-scale30 rounded-[20px]">
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 relative self-stretch w-full flex-[0_0_auto]">
